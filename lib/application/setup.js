...
const sanitization = require('../utils/validation').sanitization;
const configure = require("./configure");


function validateConfig(config) {
  if (_.isEmpty(config)) {
    const message = 'Please include a config.js file in the orchestra project root. See ./docs/config-example.js for format.'
